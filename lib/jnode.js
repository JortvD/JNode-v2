...
module.exports = function() {
	...
	self.view = function(url, filename) {
		return self.promise(function(event) {
			url = self.utils().check("string", url, "url");
			filename = self.utils().check("string", filename, "filename");
	...
	self.assets = function(folder, type) {
		return self.promise(function(event) {
			folder = self.utils().check("string", folder, "folder");
			var path = "";
	...
	self.xss = function(data) {
		data = self.utils().check("string", data, "data");
